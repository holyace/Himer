...
//	public List<String> all_track;
	...
	@Generated(hash = 956717451)
	public SearchSound(String play_path_64, long id, String title, String play_path,
			boolean is_public, long created_at, int category_id, String cover_path,
			int user_source, double duration, long updated_at, String play_path_32,
			String download_path, int upload_source, String album_cover_path,
			int album_id, String album_title, long uid, boolean is_v, String nickname,
