...
public class SearchSound {
    ...
    @Generated(hash = 1179442488)
    public SearchSound(String play_path_64, long localId, long saveTime, long id,
                       String title, String play_path, boolean is_public, long created_at,
                       int category_id, String cover_path, int user_source, double duration,
                       long updated_at, String play_path_32, String download_path, int upload_source,
                       String album_cover_path, int album_id, String album_title, long uid,
                       boolean is_v, String nickname, String avatar_path, int count_play,
                       int count_comment, int count_share, int count_like, String smallLogo,
                       boolean is_like, boolean is_playing, boolean isRelay,
                       String play_path_aac_v224) {
